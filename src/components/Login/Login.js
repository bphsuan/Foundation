        ...
        <div className="login">
          <div className="login-form">
            ...
            <div className="input-style">
              ...
              <input type="text" className="input" value={this.state.account} onChange={this.updateAccount.bind(this)} />
            </div>
            <div className="input-style password">
              <p className="letter">密碼</p>
              <input type={this.state.show ? "text" : "password"} className="input" value={this.state.password} onChange={this.updatePassword.bind(this)} />
            ...
            <div className="login-btn">
              <a onClick={this.login.bind(this)}>登入</a>
            </div>
